...
TexturedCylinderRenderable::TexturedCylinderRenderable(
    ShaderProgramPtr shaderProgram, const std::string& textureFilename, unsigned int nb_Slices)
...
void TexturedCylinderRenderable::setMaterial(const MaterialPtr& material)
{
    m_material = material;
}
